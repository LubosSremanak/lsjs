# lsJS
The LS framework allows you to work with and modulate custom HTML elements as components.
...
#### Renderer [JSDOCS](https://lubossremanak.site/ls/docs/global.html)
...
```js
 ...
 this.renderer.setAttribute(component, 'name', 'yourName');
